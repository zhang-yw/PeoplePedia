    ...
    for i in word_list:
        if i in dict:
            ...
            if len(set_0) == 0:
                ...
                set_0 = set_0 | set_2
    set_1 = set(getlist_jiao(words, path))
    set_0 = set_0 - set_1
    list_2 = list(set_0)
    return list_2
...
def search(request):
    ...
    return render_to_response('search.html', {'time':time_0, 'keywords': keywords, 'name': name, "born": born, "died": died, "almamater": almamater, "list_1": list_modified, "list_2": list_pages})
